...
export const FLUTTER_COMMAND_DELETE_PUBSPEC_LOCK = `rm -rf ${FLUTTER_NAME_FILE_CONFIG_LOCK}`;
export const FLUTTER_COMMAND_CLEAN = `${FLUTTER_COMMAND_DELETE_PUBSPEC_LOCK} && flutter clean`;
export const SETTINGS_KEY_BASE = 'emirdeliz-dart-multiple-repository-utils';
export const SETTINGS_KEY_DART_IGNORE_FOLDERS =
